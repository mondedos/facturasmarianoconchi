...
/* $Id: InputHandler.java 426576 2006-07-28 15:44:37Z jeremias $ */
...
public class InputHandler implements ErrorListener, Renderable {
	 ...
	 */
	public InputHandler(File fofile, PDFGeneador generador) {
		sourcefile = fofile;
		_generador = generador;
	}
	...
	protected void transformTo(Result result) throws FOPException {
		try {
			...
			Source src = new StreamSource(new StringReader(_generador
					.createString()));
