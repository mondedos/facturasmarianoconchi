...
public class AreaTreeInputHandler extends InputHandler {
	...
	public AreaTreeInputHandler(File xmlfile, File xsltfile, Vector params,
			PDFGeneador generador) {
		super(xmlfile, xsltfile, params, generador);
	}
	 ...
	 */
	public AreaTreeInputHandler(File atfile, PDFGeneador geneador) {
		super(atfile, geneador);
	}
	...
	public void renderTo(FOUserAgent userAgent, String outputFormat,
		...
		AreaTreeModel treeModel = new RenderPagesModel(userAgent, outputFormat,
				fontInfo, out);
		...
		Result res = new SAXResult(parser.getContentHandler(treeModel,
				userAgent));
