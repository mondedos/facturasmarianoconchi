...
{
    public class CuentaBancariaValidador
    {
        /// <summary>
        ...
        {
            cuentaCompleta = cuentaCompleta.Replace(" ", string.Empty).Replace("-", string.Empty);
            // Comprobaciones de la cadena
            if (cuentaCompleta.Length != 20)
                throw new ArgumentException("El número de cuenta no tiene el formato adecuado");
